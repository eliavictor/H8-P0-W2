...
Start
Input Array arr
Create Array Reverse
For Array arr length (i) minus 1, until equals to 0, i minus 1
For Array arr length (j) minus 1, until equals to 0, j minus 1
Push arr[i][j] to Array reverse
